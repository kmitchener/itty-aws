...
function unwrapModel(raw: any): SmithyModel {
  ...
  throw new Error(
    "Invalid Smithy JSON: expected an object with a 'shapes' property.",
  );
}
...
const genRegistry: Record<SmithyId, GenStructure | GenList | GenPrimitive> = {};
