...
export class MediaConvert extends AWSServiceClient {
  constructor(cfg: any) {
    super("mediaconvert", new RestJson1Protocol(), cfg);
  }
...
export type Codec = "UNKNOWN" | "AAC" | "AC3" | "EAC3" | "FLAC" | "MP3" | "OPUS" | "PCM" | "VORBIS" | "AV1" | "AVC" | "HEVC" | "JPEG2000" | "MJPEG" | "MP4V" | "MPEG2" | "PRORES" | "THEORA" | "VP8" | "VP9" | "C608" | "C708" | "WEBVTT";
...
export type TamsGapHandling = "SKIP_GAPS" | "FILL_WITH_BLACK" | "HOLD_LAST_FRAME";
