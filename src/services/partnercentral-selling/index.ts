...
export class PartnerCentralSelling extends AWSServiceClient {
  constructor(cfg: any) {
    super("partnercentral-selling", new AwsJson10Protocol(), cfg);
  }
...
export type AwsClosedLostReason = "ADMINISTRATIVE" | "BUSINESS_ASSOCIATE_AGREEMENT" | "COMPANY_ACQUIRED_DISSOLVED" | "COMPETITIVE_OFFERING" | "CUSTOMER_DATA_REQUIREMENT" | "CUSTOMER_DEFICIENCY" | "CUSTOMER_EXPERIENCE" | "DELAY_CANCELLATION_OF_PROJECT" | "DUPLICATE" | "DUPLICATE_OPPORTUNITY" | "EXECUTIVE_BLOCKER" | "FAILED_VETTING" | "FEATURE_LIMITATION" | "FINANCIAL_COMMERCIAL" | "INSUFFICIENT_AMAZON_VALUE" | "INSUFFICIENT_AWS_VALUE" | "INTERNATIONAL_CONSTRAINTS" | "LEGAL_TAX_REGULATORY" | "LEGAL_TERMS_AND_CONDITIONS" | "LOST_TO_COMPETITOR" | "LOST_TO_COMPETITOR_GOOGLE" | "LOST_TO_COMPETITOR_MICROSOFT" | "LOST_TO_COMPETITOR_OTHER" | "LOST_TO_COMPETITOR_RACKSPACE" | "LOST_TO_COMPETITOR_SOFTLAYER" | "LOST_TO_COMPETITOR_VMWARE" | "NO_CUSTOMER_REFERENCE" | "NO_INTEGRATION_RESOURCES" | "NO_OPPORTUNITY" | "NO_PERCEIVED_VALUE_OF_MP" | "NO_RESPONSE" | "NOT_COMMITTED_TO_AWS" | "NO_UPDATE" | "ON_PREMISES_DEPLOYMENT" | "OTHER" | "OTHER_DETAILS_IN_DESCRIPTION" | "PARTNER_GAP" | "PAST_DUE" | "PEOPLE_RELATIONSHIP_GOVERNANCE" | "PLATFORM_TECHNOLOGY_LIMITATION" | "PREFERENCE_FOR_COMPETITOR" | "PRICE" | "PRODUCT_TECHNOLOGY" | "PRODUCT_NOT_ON_AWS" | "SECURITY_COMPLIANCE" | "SELF_SERVICE" | "TECHNICAL_LIMITATIONS" | "TERM_SHEET_IMPASSE";
...
export type AwsMemberBusinessTitle = "AWS_SALES_REP" | "AWS_ACCOUNT_OWNER" | "WWPSPDM" | "PDM" | "PSM" | "ISVSM";
...
export type AwsOpportunityStage = "NOT_STARTED" | "IN_PROGRESS" | "PROSPECT" | "ENGAGED" | "IDENTIFIED" | "QUALIFY" | "RESEARCH" | "SELLER_ENGAGED" | "EVALUATING" | "SELLER_REGISTERED" | "TERM_SHEET_NEGOTIATION" | "CONTRACT_NEGOTIATION" | "ONBOARDING" | "BUILDING_INTEGRATION" | "QUALIFIED" | "ON_HOLD" | "TECHNICAL_VALIDATION" | "BUSINESS_VALIDATION" | "COMMITTED" | "LAUNCHED" | "DEFERRED_TO_PARTNER" | "CLOSED_LOST" | "COMPLETED" | "CLOSED_INCOMPLETE";
...
export type Channel = "AWS_MARKETING_CENTRAL" | "CONTENT_SYNDICATION" | "DISPLAY" | "EMAIL" | "LIVE_EVENT" | "OUT_OF_HOME" | "PRINT" | "SEARCH" | "SOCIAL" | "TELEMARKETING" | "TV" | "VIDEO" | "VIRTUAL_EVENT";
export type Channels = Array<Channel>;
export type ClientToken = string;

export type ClosedLostReason = "CUSTOMER_DEFICIENCY" | "DELAY_CANCELLATION_OF_PROJECT" | "LEGAL_TAX_REGULATORY" | "LOST_TO_COMPETITOR_GOOGLE" | "LOST_TO_COMPETITOR_MICROSOFT" | "LOST_TO_COMPETITOR_SOFTLAYER" | "LOST_TO_COMPETITOR_VMWARE" | "LOST_TO_COMPETITOR_OTHER" | "NO_OPPORTUNITY" | "ON_PREMISES_DEPLOYMENT" | "PARTNER_GAP" | "PRICE" | "SECURITY_COMPLIANCE" | "TECHNICAL_LIMITATIONS" | "CUSTOMER_EXPERIENCE" | "OTHER" | "PEOPLERELATIONSHIPGOVERNANCE" | "PRODUCTTECHNOLOGY" | "FINANCIALCOMMERCIAL";
export type CompanyName = string;

export type CompanyWebsiteUrl = string;

export type CompetitorName = "ORACLE_CLOUD" | "ON_PREM" | "CO_LOCATION" | "AKAMAI" | "ALICLOUD" | "GOOGLE_CLOUD_PLATFORM" | "IBM_SOFTLAYER" | "MICROSOFT_AZURE" | "OTHER_COST_OPTIMIZATION" | "NO_COMPETITION" | "OTHER";
...
export type DeliveryModel = "SAAS_OR_PAAS" | "BYOL_OR_AMI" | "MANAGED_SERVICES" | "PROFESSIONAL_SERVICES" | "RESELL" | "OTHER";
...
export type Industry = "AEROSPACE_SATELLITE" | "AGRICULTURE" | "AUTOMOTIVE" | "COMPUTERS_ELECTRONICS" | "CONSUMER_GOODS" | "EDUCATION" | "ENERGY_OIL_GAS" | "ENERGY_POWER_UTILITIES" | "FINANCIAL_SERVICES" | "GAMING" | "GOVERNMENT" | "HEALTHCARE" | "HOSPITALITY" | "LIFE_SCIENCES" | "MANUFACTURING" | "MARKETING_ADVERTISING" | "MEDIA_ENTERTAINMENT" | "MINING" | "NON_PROFIT_ORGANIZATION" | "PROFESSIONAL_SERVICES" | "REALESTATE_CONSTRUCTION" | "RETAIL" | "SOFTWARE_INTERNET" | "TELECOMMUNICATIONS" | "TRANSPORTATION_LOGISTICS" | "TRAVEL" | "WHOLESALE_DISTRIBUTION" | "OTHER";
...
export type InvolvementTypeChangeReason = "EXPANSION_OPPORTUNITY" | "CHANGE_IN_DEAL_INFORMATION" | "CUSTOMER_REQUESTED" | "TECHNICAL_COMPLEXITY" | "RISK_MITIGATION";
...
export type OpportunitySortName = "LAST_MODIFIEDDATE" | "IDENTIFIER" | "CUSTOMER_COMPANY_NAME";
...
export type PrimaryNeedFromAws = "CO_SELL_ARCHITECTURAL_VALIDATION" | "CO_SELL_BUSINESS_PRESENTATION" | "CO_SELL_COMPETITIVE_INFORMATION" | "CO_SELL_PRICING_ASSISTANCE" | "CO_SELL_TECHNICAL_CONSULTATION" | "CO_SELL_TOTAL_COST_OF_OWNERSHIP_EVALUATION" | "CO_SELL_DEAL_SUPPORT" | "CO_SELL_SUPPORT_FOR_PUBLIC_TENDER_RFX";
...
export type ReasonCode = "INVITATION_ACCESS_DENIED" | "INVITATION_VALIDATION_FAILED" | "ENGAGEMENT_ACCESS_DENIED" | "OPPORTUNITY_ACCESS_DENIED" | "RESOURCE_SNAPSHOT_JOB_ACCESS_DENIED" | "RESOURCE_SNAPSHOT_JOB_VALIDATION_FAILED" | "RESOURCE_SNAPSHOT_JOB_CONFLICT" | "ENGAGEMENT_VALIDATION_FAILED" | "ENGAGEMENT_CONFLICT" | "OPPORTUNITY_SUBMISSION_FAILED" | "ENGAGEMENT_INVITATION_CONFLICT" | "INTERNAL_ERROR" | "OPPORTUNITY_VALIDATION_FAILED" | "OPPORTUNITY_CONFLICT" | "RESOURCE_SNAPSHOT_ACCESS_DENIED" | "RESOURCE_SNAPSHOT_VALIDATION_FAILED" | "RESOURCE_SNAPSHOT_CONFLICT" | "SERVICE_QUOTA_EXCEEDED" | "REQUEST_THROTTLED";
interface _Receiver {
  Account?: AccountReceiver;
}

export type Receiver = (_Receiver & { Account: AccountReceiver });
export type ReceiverResponsibility = "DISTRIBUTOR" | "RESELLER" | "HARDWARE_PARTNER" | "MANAGED_SERVICE_PROVIDER" | "SOFTWARE_PARTNER" | "SERVICES_PARTNER" | "TRAINING_PARTNER" | "CO_SELL_FACILITATOR" | "FACILITATOR";
...
export type RelatedEntityType = "SOLUTIONS" | "AWS_PRODUCTS" | "AWS_MARKETPLACE_OFFERS";
...
export type ReviewStatus = "PENDING_SUBMISSION" | "SUBMITTED" | "IN_REVIEW" | "APPROVED" | "REJECTED" | "ACTION_REQUIRED";
export type SalesActivities = Array<SalesActivity>;
export type SalesActivity = "INITIALIZED_DISCUSSIONS_WITH_CUSTOMER" | "CUSTOMER_HAS_SHOWN_INTEREST" | "CONDUCTED_POC_DEMO" | "IN_EVALUATION_PLANNING_STAGE" | "AGREED_ON_SOLUTION_TO_BUSINESS_PROBLEM" | "COMPLETED_ACTION_PLAN" | "FINALIZED_DEPLOYMENT_NEEDS" | "SOW_SIGNED";
...
export type Stage = "PROSPECT" | "QUALIFIED" | "TECHNICAL_VALIDATION" | "BUSINESS_VALIDATION" | "COMMITTED" | "LAUNCHED" | "CLOSED_LOST";
