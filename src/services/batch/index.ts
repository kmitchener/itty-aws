...
export class Batch extends AWSServiceClient {
  constructor(cfg: any) {
    super("batch", new RestJson1Protocol(), cfg);
  }
...
export type ServiceEnvironmentStatus = "CREATING" | "UPDATING" | "DELETING" | "DELETED" | "VALID" | "INVALID";
...
export type ServiceJobStatus = "SUBMITTED" | "PENDING" | "RUNNABLE" | "SCHEDULED" | "STARTING" | "RUNNING" | "SUCCEEDED" | "FAILED";
