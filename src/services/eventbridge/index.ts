...
export class EventBridge extends AWSServiceClient {
  constructor(cfg: any) {
    super("eventbridge", new AwsJson11Protocol(), cfg);
  }
...
export type EndpointEventBusList = Array<EndpointEventBus>;
...
export declare namespace UpdateEventBus {
  export type Input = UpdateEventBusRequest;
  export type Output = UpdateEventBusResponse;
  export type Error =
    | ConcurrentModificationException
    | InternalException
    | OperationDisabledException
