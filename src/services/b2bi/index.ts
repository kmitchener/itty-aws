...
export class b2bi extends AWSServiceClient {
  constructor(cfg: any) {
    super("b2bi", new AwsJson10Protocol(), cfg);
  }
...
export type CapabilityConfiguration = (_CapabilityConfiguration & { edi: EdiConfiguration });
...
export type ConversionTargetFormatDetails = (_ConversionTargetFormatDetails & { x12: X12Details });
...
export type OutputSampleFileSource = (_OutputSampleFileSource & { fileLocation: S3Location });
